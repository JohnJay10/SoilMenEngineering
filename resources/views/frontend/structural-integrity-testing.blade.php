  ...
  <section class="project-post-area sectpad">
    <div class="container clearfix">
      <div class="project-post">
        <div class="row">
          <div class="col-sm-4 project-post-info">
            <div class="project-post-image image_hover"><img src="images/projects/sit1.jpeg" alt="" class="zoom_img_effect">
              <div class="info-text">
          ...
          <div class="col-sm-4 project-post-info">
            <div class="project-post-image image_hover"><img src="images/projects/sit2.jpeg" alt="" class="zoom_img_effect">
              <div class="info-text">
                {{-- <h4>Oil Plant Project</h4><a href="projects-details.html">View Details</a> --}}
              </div>
            </div>
          ...
          <div class="col-sm-4 project-post-info">
            <div class="project-post-image image_hover"><img src="images/projects/sit3.jpeg" alt="" class="zoom_img_effect">
              <div class="info-text">
                {{-- <h4>Oil Plant Project</h4><a href="projects-details.html">View Details</a> --}}
              </div>
            </div>
      ...
      <div class="project-post">
        <div class="row">
          <div class="col-sm-4 project-post-info">
            <div class="project-post-image image_hover"><img src="images/projects/sit4.jpeg" alt="" class="zoom_img_effect">
              <div class="info-text">
                {{-- <h4>Oil Plant Project</h4><a href="projects-details.html">View Details</a> --}}
              </div>
            </div>
          ...
          <div class="col-sm-4 project-post-info">
            <div class="project-post-image image_hover"><img src="images/projects/sit5.jpeg" alt="" class="zoom_img_effect">
              <div class="info-text">
                {{-- <h4>Oil Plant Project</h4><a href="projects-details.html">View Details</a> --}}
              </div>
            </div>
          ...
          <div class="col-sm-4 project-post-info">
            <div class="project-post-image image_hover"><img src="images/projects/sit6.jpeg" alt="" class="zoom_img_effect">
              <div class="info-text">
                {{-- <h4>Oil Plant Project</h4><a href="projects-details.html">View Details</a> --}}
              </div>
            </div>
      ...
      <div class="project-post">
        <div class="row">
          <div class="col-sm-4 project-post-info">
            <div class="project-post-image image_hover"><img src="images/projects/sit7.jpeg" alt="" class="zoom_img_effect">
              <div class="info-text">
                {{-- <h4>Oil Plant Project</h4><a href="projects-details.html">View Details</a> --}}
              </div>
            </div>
          ...
          <div class="col-sm-4 project-post-info">
            <div class="project-post-image image_hover"><img src="images/projects/sit8.jpeg" alt="" class="zoom_img_effect">
              <div class="info-text">
                {{-- <h4>Oil Plant Project</h4><a href="projects-details.html">View Details</a> --}}
              </div>
            </div>
