    ...
    <div class="container clearfix">
      <div class="project-post">
          <div class="row">
            ...
            <div class="row">
                @foreach($LabTestServices->chunk(3) as $chunk)
                    <div class="row">
                        @foreach($chunk as $index => $LabTestService)
                            <div class="col-md-4 project-post-info">
                                <div class="project-post-image image_hover">
                                    <img src="{{ asset($LabTestService->image) }}" alt="Image {{ $index + 1 }}" class="zoom_img_effect">
                                    <div class="info-text">
                                        <h4>{{ $LabTestService->title }}</h4>
        ...
        @endif
          ...
          {{ $LabTestServices->links('pagination::bootstrap-4') }}
